...
class ConditionGroupWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      label:
          '${isRoot ? "Root" : "Nested"} condition group matching ${node.operator}',
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Semantics(
                  label: 'Match condition operator',
                  child: const Text(
                    'Match',
                    ...
                    child: AppDropdownField<String>(
                      ...
                      items: const [
                        DropdownMenuItem(
                          value: 'AND',
                          child:
                              Text('ALL (AND)', style: TextStyle(fontSize: 12)),
                        ),
                        DropdownMenuItem(
                          value: 'OR',
                          child:
                              Text('ANY (OR)', style: TextStyle(fontSize: 12)),
                        ),
                        DropdownMenuItem(
                          value: 'NOT',
                          child: Text(
